...
dirty-up: start-dependencies start-management-services

set-up: install-docker-if-not-already-installed build-all-docker-images set-up-db

reset: wipe-all set-up down set-up-db
